...
# put these numbers on front end or limit the numbers able to be input from 1 to max so there is no way to break it 
print("Maximum Number of Cancer Patient Volunteers is", MaxPatients("CANCER"))
print("Maximum Number of HIV Patient Volunteers is", MaxPatients("HIV"))
print("Maximum Number of Alzheimer's Patient Volunteers is", MaxPatients("ALZHEIMERS"))

# Please round the miles to hundreth decimal place on front end 



result = FindBestPath("CANCER", 24600)
print(result)
VolunteersList = VolunteersInEachCity(result, "CANCER")
